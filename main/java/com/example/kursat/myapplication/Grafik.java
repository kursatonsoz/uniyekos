...
/**
 * Created by mehmet.nakilcioglu on 06.05.2015.
 */
public class Grafik extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState==null){
            String gunss = getIntent().getStringExtra("gun");
            TextView tv = (TextView) findViewById(R.id.textView23);
            Toast.makeText(this,gunss,Toast.LENGTH_LONG).show();
            tv.setText(gunss);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            View digeri = inflater.inflate(R.layout.grafik,container,false);

            chart = (LineChartView) rootView.findViewById(R.id.chart);
            chart.setOnValueTouchListener(new ValueTouchListener());

            TextView tvv = (TextView) digeri.findViewById(R.id.textView23);
            gunler = tvv.getText().toString();
