...
public class FragCumartesi extends Fragment {

    final List<Prog> prog = new ArrayList<Prog>();

    public String email_;

    public FragCumartesi(String email) {
        this.email_ = email;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.frag_cumartesi, container, false);
        Database d = new Database(super.getActivity());
        Cursor c = d.programCek("5",this.email_);
        prog.clear();
        Prog p = new Prog();
        ...
        final ListView listem = (ListView) rootView.findViewById(R.id.cts_liste);
