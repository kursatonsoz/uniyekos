...
public class FragPersembe extends Fragment {

    final List<Prog> prog = new ArrayList<Prog>();

    public String email_;

    public FragPersembe(String email) {
        this.email_ = email;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.frag_persembe, container, false);
        Database d = new Database(super.getActivity());
        Cursor c = d.programCek("3",this.email_);
        prog.clear();
        Prog p = new Prog();
        ...
        final ListView listem = (ListView) rootView.findViewById(R.id.pers_liste);
