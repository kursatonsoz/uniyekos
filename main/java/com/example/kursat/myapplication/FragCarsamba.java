...
public class FragCarsamba extends Fragment {

    final List<Prog> prog = new ArrayList<Prog>();

    public String email_;

    public FragCarsamba(String email) {
        this.email_ = email;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.frag_carsamba, container, false);
        Database d = new Database(super.getActivity());
        Cursor c = d.programCek("2",this.email_);
        prog.clear();
        Prog p = new Prog();
        p.setEmail(this.email_);
        p.setGun("2");
        p.setDers("Bu Güne Ait Kayıtlı Program Bulunamadı 11076160642");
        p.setBasla("");
        p.setBitir("");
        p.setNotlar("");
        prog.add(p);
        ...
        final ListView listem = (ListView) rootView.findViewById(R.id.cars_liste);
